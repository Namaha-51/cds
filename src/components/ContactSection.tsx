...
export default function ContactSection() {
    ...
    const CONTACT_INFO = [
        {
            icon: PhoneCall,
            title: "PRIORITY TELEPHONE LINE",
            val: "0405 545 609",
            sub: "Direct access to lead technicians & dispatch.",
            href: "tel:0405545609",
        ...
        },
        {
            ...
            val: "info@cdsapplianceservices.com.au",
            sub: "Send work orders, brand specs, or enquiries.",
            href: "mailto:info@cdsapplianceservices.com.au",
            badge: "INBOX MONITORED",
        ...
        },
        {
            ...
            sub: "Fully equipped testing & parts workshop.",
            href: "#",
            badge: "CENTRAL HQ",
        ...
        },
        {
            ...
            sub: "Weekend emergency dispatch upon request.",
            href: "#",
            badge: "EXTENDED SLOTS",
    ...
    return (
        <section className="relative bg-white text-slate-800 overflow-hidden select-none">
            ...
            {/* 📍 1. TOP ARCHITECTURAL HERO (Top padding reduced to remove blank space) */}
                            ...
                            <div className="relative aspect-[4/3] w-full max-w-lg lg:max-w-none ml-auto rounded-sm overflow-hidden border-2 border-slate-300 bg-white p-3 shadow-2xl group">
                                ...
                                <div className="absolute bottom-6 left-6 z-20 bg-white/95 backdrop-blur-md border border-slate-300 p-3.5 rounded-sm shadow-xl max-w-[210px]">
                                    ...
                                    <div className="text-[#0B1E36] font-sans text-xs font-black leading-tight">
                                        Same-Day & Next-Day Dispatch Available
                                    </div>
                                </div>
                        ...
                        <motion.div custom={1} initial="hidden" animate="visible" variants={fadeUp} className="lg:col-span-5 space-y-6">
                            ...
                            <div className="space-y-2 pb-2">
                                ...
                                <p className="text-sm text-slate-600 font-sans leading-relaxed">
                                    Establish contact through direct lines or visit our central Noble Park headquarters.
                                </p>
                            </div>
                                ...
                                {isSubmitted ? (
                                    ...
                                    >
                                        ...
                                        <div className="space-y-2 max-w-md mx-auto">
                                            ...
                                            <p className="text-sm text-slate-600 font-sans leading-relaxed">
                                                Thank you, <strong className="text-[#0B1E36]">{formData.name}</strong>. Our dispatch team has received your details for mobile contact at <strong className="text-[#0B1E36]">{formData.phone}</strong>. We will reach out shortly to confirm your appointment.
                                            </p>
                                        </div>
                                        <button
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-6 font-sans">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                            ...
                                            <div className="space-y-2">
                                                <label className="text-xs font-bold text-[#0B1E36] uppercase tracking-wide flex items-center gap-1.5">
                                                    <PhoneCall className="w-3.5 h-3.5 text-[#0284C7]" /> Direct Contact Number
                                                </label>
                                                <input
                                                    type="tel"
                                                    required
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                            ...
                                            <div className="space-y-2">
                                                <label className="text-xs font-bold text-[#0B1E36] uppercase tracking-wide flex items-center gap-1.5">
                                                    <MapPin className="w-3.5 h-3.5 text-[#0284C7]" /> Property Suburb
                                                </label>
                                                <input
                                                    type="text"
                                                    required
                                                    placeholder="e.g. Brighton, Dandenong..."
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-xs font-bold text-[#0B1E36] uppercase tracking-wide flex items-center gap-1.5">
                                                <Calendar className="w-3.5 h-3.5 text-[#0284C7]" /> Preferred Time Window
                                            </label>
                                            <select
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-xs font-bold text-[#0B1E36] uppercase tracking-wide flex items-center gap-1.5">
                                                <MessageSquare className="w-3.5 h-3.5 text-[#0284C7]" /> Fault Description
                                            </label>
                                            <textarea
                                                rows={3}
                                                placeholder="Describe error codes, noises, or operational issues..."
                                        ...
                                        <div className="pt-2">
                                            ...
                                            >
                                                ...
                                                <span>Initialize Dispatch Request</span>
                                            </button>
                                            <p className="text-[11px] text-center font-sans text-slate-500 mt-3 font-medium">
                                                No upfront payment required. We diagnose and quote on-site before proceeding.
                                            </p>
                                        </div>
            ...
            <div className="relative py-20 bg-[#F8FAFC] border-t border-slate-200">
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center space-y-6 max-w-2xl mx-auto relative z-10">
                    ...
                    <p className="text-sm sm:text-base text-slate-600 font-sans leading-relaxed font-medium">
                        Stop water leaks or cooling failures immediately. Call Chris directly on our priority mobile line.
                    </p>
                    <div className="pt-2">
                        <a
                            href="tel:0405545609"
